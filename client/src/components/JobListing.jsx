          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span
                    className="inline-flex items-center gap-2.5 bg-blue-50 border-blue-200 px-4 py-1.5
                  rounded"
                  >
                    {searchFilter.title}
                    <img
                ...
                {searchFilter.location && (
                  <span
                    className="ml-2 inline-flex items-center gap-2.5 bg-red-50 border-red-200 px-4 py-1.5
                  rounded"
                  >
                    {searchFilter.location}
                    <img
              ...
              (_, index) => (
                <a key={index} href="#job-list">
                  <button
                    ...
                    className={`w-10 h-10 flex items-center justify-center border bg-gray-300 rounded ${
                      currentPage === index + 1
