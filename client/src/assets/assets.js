...
export const manageJobsData = [
    { _id: 1, title: "Software  Developer", date: 1729102298497, location: "Bangalore", applicants: 20 },
    { _id: 2, title: "Data Scientist", date: 1729102298497, location: "Dubai", applicants: 15 },
    { _id: 3, title: "Marketing Manager", date: 1729102298497, location: "Noida", applicants: 2 },
    { _id: 4, title: "UI/UX Designer", date: 1729102298497, location: "Delhi", applicants: 25 }
];
...
export const viewApplicationsPageData = [
    { _id: 1, name: "Richard Sanford", jobTitle: "Software  Developer", location: "Bangalore", imgSrc: profile_img },
    { _id: 2, name: "Enrique Murphy", jobTitle: "Data Scientist", location: "Dubai", imgSrc: profile_img },
    { _id: 3, name: "Alison Powell", jobTitle: "Marketing Manager", location: "Noida", imgSrc: profile_img },
    { _id: 4, name: "Richard Sanford", jobTitle: "UI/UX Designer", location: "Delhi", imgSrc: profile_img },
    { _id: 5, name: "Enrique Murphy", jobTitle: "Software  Developer", location: "Hyderabad", imgSrc: profile_img },
...
export const jobsData = [
    {
        ...
        description: `
        <p>We are seeking a highly skilled Software  Developer to join our dynamic and innovative team. The ideal candidate will have a passion for developing scalable web applications and working across the entire technology stack, including front-end and back-end development. You will have the opportunity to work with the latest technologies and contribute to exciting projects that impact our users directly.</p>
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficient in Java or C# with a solid understanding of object-oriented Software .</li>
    ...
    },
    {
        ...
        description: `
        <p>Join our innovative team as a Data Scientist, where you will analyze complex data sets to drive strategic decision-making. You will leverage your statistical and Software  skills to uncover insights and develop predictive models, contributing to the overall success of our organization.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficiency in Software  languages such as Python or R.</li>
